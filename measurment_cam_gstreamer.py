...
gst_pipeline = "appsrc ! videoconvert ! nvh264enc ! rtph264pay config-interval=1 pt=96 ! udpsink host=192.168.137.7 port=9999"

fps = 30
width, height = 3840, 2160
streamer = cv2.VideoWriter(gst_pipeline, cv2.CAP_GSTREAMER, 0, fps, (width, height), True)  # GStreamer pipeline start
